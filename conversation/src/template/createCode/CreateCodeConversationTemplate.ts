import { fileOrDirectoryExistsFunction, readFilesFunction } from '../../fs/conversation_fs/FsFunctions';
...
export const createCodeConversationTemplate: ConversationTemplate = {
  ...
  instructions: async () => {
    return [
      ...
      `1.b. Use the ${readFilesFunction.definition.name} function to read the package.json file, reference this throughout the conversation in the fileSystem`,
