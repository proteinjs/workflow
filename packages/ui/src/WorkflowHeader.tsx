...
export const WorkflowHeader = ({
  ...
  currentStep,
  updateCurrentStep,
}: Omit<WorkflowComponentProps, 'workflowHeader'>) => {
  return (
    <Accordion
      sx={{
    ...
    >
      <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls='workflow-accordion' id='workflow-accordion'>
        <Typography sx={{ width: '33%', flexShrink: 0 }}>{workflow?.name}</Typography>
