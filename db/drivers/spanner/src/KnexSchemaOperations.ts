...
export class KnexSchemaOperations implements SchemaOperations {
  ...
  async createTable(table: Table<any>) {
    ...
    await this.knexDriver.getSpanner().schema.withSchema(this.knexDriver.getDbName()).createTable(table.name, (tableBuilder: knex.TableBuilder) => {
  ...
  async alterTable(table: Table<any>, tableChanges: TableChanges) {
		...
		await this.knexDriver.getSpanner().schema.withSchema(this.knexDriver.getDbName()).table(table.name, (tableBuilder: knex.TableBuilder) => {
