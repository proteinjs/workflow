...
export class Class extends PackageScope {
	constructor(
		...
		public readonly directParents: {[qualifiedName: string]: Class|Interface} = {},
		public readonly typeParameters: {[qualifiedName: string]: (TypeAlias|Interface)[]} = {},
		public allParents: {[qualifiedName: string]: Class|Interface} = {},
		public rootParents: {[qualifiedName: string]: Class|Interface} = {},
...
export class Interface extends PackageScope {
	constructor(
		...
		filePath?: string,
		public readonly typeParameters: {[qualifiedName: string]: (TypeAlias|Interface)[]} = {},
		public readonly directParents: {[qualifiedName: string]: Interface} = {},
		public allParents: {[qualifiedName: string]: Interface} = {},
		public rootParents: {[qualifiedName: string]: Interface} = {},
